...
class PoormansImplementationTest extends TestHelper
{
    ...
    public function searchQueryProvider()
    {
        return [
            ...
            [
                ...
                [
                    '$and' => [
                        ['foo' => new \MongoRegex('/some/i')],
                        ['foo' => new \MongoRegex('/terms/i')],
                        ['foo' => new \MongoRegex('/here/i')]
                    ]
                ]
            ],
            [
                ...
                [
                    '$and' => [
                        [
                            '$or' => [
                                ['foo' => new \MongoRegex('/terms/i')],
                                ['bar' => new \MongoRegex('/terms/i')],
                                ['zet' => new \MongoRegex('/terms/i')]
                            ]
                        ]
                    ]
                ]
                ...
                [
                    '$and' => [
                        [
                            '$or' => [
                                ['foo' => new \MongoRegex('/some/i')],
                                ['bar' => new \MongoRegex('/some/i')],
                                ['zet' => new \MongoRegex('/some/i')]
                            ]
                        ],
                        [
                            '$or' => [
                        ...
                        [
                            '$or' => [
                                ['foo' => new \MongoRegex('/here/i')],
                                ['bar' => new \MongoRegex('/here/i')],
                                ['zet' => new \MongoRegex('/here/i')]
                            ]
                        ],
                    ]
                ]
     ...
     */
    public function testSearch($sort, $sortQuery, $limit, $setLimit, $setSkip)
    {
        $terms = 'terms';
        $filter = ['foo' => 'bar'];
        $query = [
